...
RSpec.describe AHPComparisonCalculator, type: :service do
  ...
  let(:expected_result) { 
    { 
      ...
      "1" => { "id" => "1", "comparable_id" => "11", "comparable_type" => 'Alternative', "score"=>"0.2171656088028061",  "score_n"=>"0.2171656088028061",  "rank"=>"2" }, 
      "3" => { "id" => "3", "comparable_id" => "13", "comparable_type" => 'Alternative', "score"=>"0.06576934996841792", "score_n"=>"0.06576934996841792", "rank"=>"3" } 
    }
  }
