require 'foreplot/decision/ahp/ahp_matrix'
require 'foreplot/decision/ahp/analytic_hierarchy_process'
require 'foreplot/decision/ahp_ranking'

RSpec.describe Foreplot::Decision::AhpRanking do
  ...
  describe ".new" do
    it "creates a valid AhpRanking object" do
      ahp_ranking = Foreplot::Decision::AhpRanking.new choices, decision_matrix
      expect(ahp_ranking.class).to eq(Foreplot::Decision::AhpRanking)
