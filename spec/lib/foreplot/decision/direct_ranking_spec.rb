require 'foreplot/decision/direct_ranking'

RSpec.describe Foreplot::Decision::DirectRanking do
  ...
  describe ".new" do
    it "creates a valid DirectRanking object" do
      direct_ranking = Foreplot::Decision::DirectRanking.new choices
      expect(direct_ranking.class).to eq(Foreplot::Decision::DirectRanking)
